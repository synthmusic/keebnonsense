...
thm.Add("Enter", thmEnter,,,,,,,0,true)
thm.Add("CapsLock", thmEnter,,,,,,,0,true)
thmEnter(held, taps, state, rolled, mods) {
...
GetLayer() {
    ...
    if GetKeyState("Enter", "P") || GetKeyState(SINGLE_QUOTE, "P") || GetKeyState("CapsLock", "P") {
        return "EntPair"
    }
